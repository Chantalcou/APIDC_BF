  ...
  return (
    <div className="payment-shipping-section">
        ...
        <div className="payment-methods">
          ...
          <ul className="method-list">
            <li className="method-item">
              ...
              <span className="method-detail">(Al recibir tu pedido)</span>
            </li>
            <li className="method-item">
        ...
        <div className="shipping-methods">
          ...
          <div className="shipping-details">
            ...
            <p className="shipping-info">
              Entregas seguras por Andreani<br/>
              <span className="highlight">Todo el territorio nacional</span>
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="process-info">
        ...
        <p>
          <strong>Proceso posterior al pago:</strong><br/>
          1. Envíanos el comprobante por WhatsApp<br/>
          2. Coordinamos el envío inmediatamente<br/>
